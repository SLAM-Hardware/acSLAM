...
HD_PWD='F:/Xilinx/user/vivado/heap_with_fifo/heap_with_fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heap_rtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heap_rtl.tcl
