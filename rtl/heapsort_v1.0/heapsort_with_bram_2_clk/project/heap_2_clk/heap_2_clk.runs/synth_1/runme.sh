...
HD_PWD='F:/Xilinx/user/vivado/heap_2_clk/heap_2_clk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heap.tcl
