...
proc create_root_design { parentCell } {
  ...
  set my_reg_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_reg:1 my_reg_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins my_reg_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net my_reg_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins my_reg_0/M_AXIS]
