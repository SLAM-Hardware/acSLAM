...
################################################################
# This is a generated script based on design: RS_BRIEF
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_dma_des, and set properties
  set axi_dma_des [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_des ]
  ...
  # Create instance: axi_dma_src, and set properties
  set axi_dma_src [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_src ]
  set_property -dict [ list \
  ...
  # Create instance: rst_clk_wiz_0_140M, and set properties
  set rst_clk_wiz_0_140M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_0_140M ]
  ...
  connect_bd_intf_net -intf_net RS_BRIEF_0_descriptor_out [get_bd_intf_pins RS_BRIEF_0/descriptor_out] [get_bd_intf_pins axi_dma_des/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_des_M_AXI_S2MM [get_bd_intf_pins axi_dma_des/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_src_M_AXIS_MM2S [get_bd_intf_pins RS_BRIEF_0/srcStream] [get_bd_intf_pins axi_dma_src/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_src_M_AXI_MM2S [get_bd_intf_pins axi_dma_src/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_des/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axi_dma_src/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net axi_dma_des_s2mm_introut [get_bd_pins axi_dma_des/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_dma_src_mm2s_introut [get_bd_pins axi_dma_src/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins RS_BRIEF_0/ap_clk] [get_bd_pins axi_dma_des/m_axi_s2mm_aclk] [get_bd_pins axi_dma_src/m_axi_mm2s_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins rst_clk_wiz_0_140M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_140M/dcm_locked]
  connect_bd_net -net rst_clk_wiz_0_140M_interconnect_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins rst_clk_wiz_0_140M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_0_140M_peripheral_aresetn [get_bd_pins RS_BRIEF_0/ap_rst_n] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins rst_clk_wiz_0_140M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_100M_interconnect_aresetn [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_dma_des/axi_resetn] [get_bd_pins axi_dma_src/axi_resetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_des/s_axi_lite_aclk] [get_bd_pins axi_dma_src/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins rst_clk_wiz_0_140M/ext_reset_in] [get_bd_pins rst_ps8_0_100M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_des/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_src/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_des/S_AXI_LITE/Reg] SEG_axi_dma_des_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_src/S_AXI_LITE/Reg] SEG_axi_dma_src_Reg
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_des/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_des/Data_S2MM/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_src/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_src/Data_MM2S/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]
